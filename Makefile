OBJECTS= ./build/compiler.o ./build/cprocess.o ./build/lexer.o ./build/token.o ./build/lex_process.o ./build/node.o ./build/expressionable.o ./build/parser.o ./build/helpers/buffer.o ./build/helpers/vector.o
INCLUDES= -I./
