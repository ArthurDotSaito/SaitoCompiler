...
static void lex_finish_expression()
{
    ...
    {
        compiler_error(lex_process->compiler, "Unexpected. You closed a expression that you never opened\n");
    }
}
...
struct token *token_multiline_comment()
{
    struct buffer *buffer = buffer_create();
    char c = nextc();
    while (1)
